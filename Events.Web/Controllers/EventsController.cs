...
namespace Events.Web.Controllers
{
    ...
    public class EventsController : BaseController
    {
        public ActionResult My()
        {
            ...
            var upcomingEvents = events.Where(e => e.EndDateTime > DateTime.Now);
            var passedEvents = events.Where(e => e.EndDateTime <= DateTime.Now);
        ...
        public ActionResult Edit(int id, EventInputModel model)
        {
            ...
            if (model != null && this.ModelState.IsValid)
            {
                ...
                eventToEdit.EndDateTime = model.EndDateTime;
